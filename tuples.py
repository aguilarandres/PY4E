...
for message in messages:
  ...
  # create a substring representing the hour of the time signature
  value = message[index_of_target - 2 : index_of_target]
  hours[value] = hours.get(value, 0) + 1

# use items() method on the hours dictionary to return a list of (key, value) tuples
# sorted() takes a sequence and returns a sorted sequence
